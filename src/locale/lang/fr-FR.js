...
exports.default = {
    ...
    vanCalendar: {
        ...
        rangePrompt: function (maxRange) { return "Choisir pas plus de " + maxRange + " jours"; },
    },
    vanCascader: {
        select: 'Sélectionner',
    },
    ...
    vanCoupon: {
        unlimited: 'Illimité',
        discount: function (discount) { return discount * 10 + "% de r\u00E9duction"; },
        condition: function (condition) { return "Au moins " + condition; },
    },
    vanCouponCell: {
        title: 'Coupon',
        tips: 'Pas de coupons',
        count: function (count) { return "Vous avez " + count + " coupons"; },
    },
    vanCouponList: {
