...
exports.default = {
    ...
    vanCalendar: {
        ...
        monthTitle: function (year, month) { return year + "\u5E74" + month + "\u6708"; },
        rangePrompt: function (maxRange) { return maxRange + "\u65E5\u4EE5\u5185\u3092\u9078\u629E\u3057\u3066\u304F\u3060\u3055\u3044"; },
    },
    vanCascader: {
        select: '選択する',
    },
    ...
    vanCoupon: {
        unlimited: '入場ありません',
        discount: function (discount) { return 10 - discount + "\u5272\u5F15"; },
        condition: function (condition) { return condition + "\u5186\u4EE5\u4E0A\u3067\u5229\u7528\u53EF\u80FD"; },
    },
    vanCouponCell: {
        title: 'クーポン',
        tips: '利用可能なクーポンがありません',
        count: function (count) { return count + "\u679A\u304C\u5229\u7528\u53EF\u80FD"; },
    },
    vanCouponList: {
        empty: 'クーポンはありません',
        exchange: '両替',
