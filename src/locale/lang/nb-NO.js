...
exports.default = {
    ...
    vanCalendar: {
        ...
        rangePrompt: function (maxRange) { return "Maks. " + maxRange + " dager"; },
    },
    vanCascader: {
        select: 'Plukke ut',
    },
    ...
    vanCoupon: {
        unlimited: 'Uendelig',
        discount: function (discount) { return discount * 10 + "% avslag"; },
        condition: function (condition) { return "Minst " + condition; },
    },
    vanCouponCell: {
        title: 'Kupong',
        tips: 'Ingen kuponger',
        count: function (count) { return "Du har " + count + " kuponger"; },
    },
    vanCouponList: {
