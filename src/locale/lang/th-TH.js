...
exports.default = {
    ...
    vanCalendar: {
        ...
        monthTitle: function (year, month) { return year + "\u0E1B\u0E35" + month + "\u0E40\u0E14\u0E37\u0E2D\u0E19"; },
    ...
    vanCoupon: {
        ...
        discount: function (discount) { return "\u0E25\u0E14" + discount; },
        condition: function (condition) { return "\u0E21\u0E35\u0E08\u0E33\u0E2B\u0E19\u0E48\u0E32\u0E22\u0E43\u0E19\u0E23\u0E32\u0E04\u0E32 " + condition + " \u0E01\u0E27\u0E48\u0E32\u0E2B\u0E22\u0E27\u0E19"; },
    },
    vanCouponCell: {
        title: 'คูปอง',
        tips: 'ไม่สามารถใช้ได้',
        count: function (count) { return "\u0E21\u0E35\u0E23\u0E39\u0E1B\u0E20\u0E32\u0E1E " + count + " \u0E23\u0E39\u0E1B"; },
    },
    vanCouponList: {
        empty: 'ไม่มีคูปอง',
        exchange: 'แลกเปลี่ยน',
